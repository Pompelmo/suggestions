...
RUN DEBIAN_FRONTEND=noninteractive apt-get update -qq && apt-get upgrade -qq -y && apt-get install -qq -y python-numpy \
                    python-scipy python-pip build-essential python python-dev gfortran libatlas-base.dev curl
